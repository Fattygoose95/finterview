...
function initHomePage() {
    ...
    // 显示加载状态
    industryGrid.innerHTML = '<div class="loading-state"><i class="fas fa-spinner fa-spin"></i> 加载行业数据...</div>';
    ...
    DataLoader.init()
        ...
        .catch(error => {
            ...
            industryGrid.innerHTML = '<div class="error-state"><i class="fas fa-exclamation-triangle"></i> 加载失败，请刷新页面重试</div>';
        });
}
...
function loadIndustryQuestions(industryId) {
    ...
    // 显示加载状态
    questionGrid.innerHTML = '<div class="loading-state"><i class="fas fa-spinner fa-spin"></i> 加载题目...</div>';
    ...
    DataLoader.init()
        ...
        .catch(error => {
            ...
            questionGrid.innerHTML = '<div class="error-state"><i class="fas fa-exclamation-triangle"></i> 加载失败，请刷新页面重试</div>';
        });
}
